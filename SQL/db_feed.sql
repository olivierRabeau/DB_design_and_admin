...
INSERT INTO S_managing.T_complexes (complex_name, complex_address, complex_phone, complex_email)
VALUES 
(N'UGC Ciné Cité Paris 19', N'166 Boulevard Macdonald à Paris (19ème arrondissement)', N'+330176647997', N'cine-cite-paris@ugc.com'),
(N'UGC Ciné Cité Strasbourg', N'25, avenue du Rhin 67100 STRASBOURG', N'+330146372824', N'cine-cite-strasbourg@ugc.com'),
(N'UGC Ciné Cité Internationale', N'Cité Internationale - 80, quai Charles de Gaulle 69006 LYON', N'+330146372824', N'cine-cite-lyon@ugc.com');

INSERT INTO S_managing.T_rooms (room_number, room_seats, room_complex)
VALUES 
...
INSERT INTO S_managing.T_roles (role_name)
VALUES 
(N'Administrateur'), 
(N'Programmeur'), 
(N'projectioniste'), 
...
INSERT INTO S_managing.T_employees (employee_name, employee_firstname, employee_address,
...
INSERT INTO S_welcoming.T_customers (customer_name,	customer_firstname,	customer_phone,	customer_email)
VALUES
...
INSERT INTO S_welcoming.T_reservations (reservation_customer, reservation_mvscr, reservation_price,	reservation_reduction)
VALUES
